...
<head>
    ...
    <title>Subject Management — School Management</title>
    ...
    <style>
        ...
        .subject-card:hover .action-btns { opacity: 1; }
...
<body>
        ...
        <div class="main-content flex-grow-1">
            <header class="d-flex justify-content-between align-items-center mb-5">
                <div>
                    ...
                    <p class="text-muted mb-0">Academic Subject Directory</p>
                </div>
                <div class="dropdown">
            ...
            <div id="formView">
                <div class="premium-card mx-auto" style="max-width: 600px;">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h4 class="fw-bold mb-0" id="formTitle"><i class="fa-solid fa-book-medical me-2 text-primary"></i>Register Subject</h4>
                        <button class="btn btn-light rounded-pill btn-sm" onclick="toggleView()"><i class="fa-solid fa-layer-group me-2"></i>All Subjects</button>
                    </div>
                    ...
                    <form id="subjectForm">
                        ...
                        <div class="row g-4">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="name" id="field_name" required placeholder="e.g. Advanced Physics, Literature">
                            </div>
                            <div class="col-md-12 pt-3 d-flex justify-content-end gap-3">
                                ...
                                <button type="button" class="btn btn-premium px-5" id="btnSave">
                                    <span id="saveLabel">Register Subject</span>
            ...
            <div id="listView" class="d-none">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="fw-bold text-dark mb-0">Subjects Library</h4>
                    <button class="btn btn-premium rounded-pill" onclick="toggleView()"><i class="fa-solid fa-plus me-2"></i>Add Subject</button>
                </div>
    ...
    <script>
        (function() {
            ...
            document.getElementById('userAvatar').src = 'https://ui-avatars.com/api/?name=' + encodeURIComponent(user.name || 'U') + '&background=6366f1&color=fff&bold=true';
            ...
            async function loadList() {
                ...
                try {
                    ...
                    if (res && res.success) {
                        const rows = res.data || [];
                        if (!rows.length) {
                            gridEl.innerHTML = '<div class="col-12 text-center py-5"><p class="text-muted">No subjects found.</p></div>';
                        } else {
                            gridEl.innerHTML = rows.map(r => `
                                <div class="col-lg-4 col-md-6">
                                     <div class="subject-card">
                                         ...
                                         <h5 class="fw-bold mb-2">${esc(r.name || r.title)}</h5>
                                         <div class="small text-muted"><i class="fa-solid fa-hashtag me-2"></i>Subject ID: ${esc(r.id)}</div>
                                     </div>
                                 </div>
                            `).join('');
            ...
            async function openEdit(id) {
                ...
                try {
                    ...
                    if (res && res.success) {
                        const r = res.data;
                        document.getElementById('field_id').value = r.id || r.subject_id;
                        document.getElementById('field_name').value = r.name || r.title || '';
                        document.getElementById('formTitle').innerHTML = '<i class="fa-solid fa-pen-to-square me-2 text-primary"></i>Edit Subject';
                        document.getElementById('saveLabel').textContent = 'Update Subject';
            ...
            btnSave.onclick = async () => {
                ...
                try {
                    ...
                    const res = await apiFetch(path, { method, body: JSON.stringify({ name }) });
                    if (res && res.success) {
                        resetForm();
                        toggleView('list');
                        loadList();
            ...
            window.resetForm = () => {
                ...
                document.getElementById('formTitle').innerHTML = '<i class="fa-solid fa-book-medical me-2 text-primary"></i>Register Subject';
                document.getElementById('saveLabel').textContent = 'Register Subject';
            };
