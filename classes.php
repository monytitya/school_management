...
<head>
    ...
    <title>Classes Management — School Management</title>
        ...
        <div class="main-content flex-grow-1">
            <header class="d-flex justify-content-between align-items-center mb-4">
                <div class="d-flex align-items-center">
                    ...
                    <span class="badge bg-danger-subtle text-danger border border-danger-subtle rounded px-2 py-1" style="font-size: 0.70rem;">Classes</span>
                </div>
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                <div>
                    <h4 class="fw-bold mb-1 text-dark">School Classes</h4>
                    <p class="text-muted small mb-0">Define and manage academic classes and assign teachers.</p>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 border-0 shadow">
                <div class="modal-header border-0 pb-0">
                    <h5 class="modal-title fw-bold" id="modalTitle">Add Class</h5>
                    ...
                    <form id="mainForm">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control rounded-3" name="name" id="field_name" required placeholder="e.g. 10A, Physics Advanced">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label small">Grade Level *</label>
                                <input type="text" class="form-control rounded-3" name="grade_level" id="field_grade_level" required placeholder="e.g. Grade 10">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label small">Academic Year *</label>
                                <input type="text" class="form-control rounded-3" name="academic_year" id="field_academic_year" required value="2024-2025">
                            </div>
                            <div class="col-md-12">
        ...
        (function() {
                ...
                try {
                    ...
                    if (res && res.success && res.data) {
                        teacherSelect.innerHTML = '<option value="">(Unassigned)</option>' + 
                            res.data.map(t => `<option value="${t.id}">${esc(t.name)} (${esc(t.employee_id)})</option>`).join('');
                    }
            ...
            async function loadList() {
                ...
                try {
                    ...
                    const rows = res.data || [];
                    if (!rows.length) {
                        bodyEl.innerHTML = '<tr><td colspan="6" class="text-center py-4 text-muted">No classes found.</td></tr>';
                        return;
                    }
                    bodyEl.innerHTML = rows.map(r => {
                        ...
                        return `<tr>
                            ...
                            <td>${esc(r.teacher_name || '(Unassigned)')}</td>
            ...
            async function openEdit(id) {
                ...
                document.getElementById('field_grade_level').value = r.grade_level || '';
                document.getElementById('field_academic_year').value = r.academic_year || '2024-2025';
            ...
            btnSave.addEventListener('click', async () => {
                ...
                const payload = {
                    ...
                    grade_level: document.getElementById('field_grade_level').value.trim(),
                    academic_year: document.getElementById('field_academic_year').value.trim(),
                    teacher_id: document.getElementById('field_teacher_id').value || null
                };
                if (!payload.name || !payload.grade_level) { alert('Name and Grade Level are required.'); return; }
            ...
            Promise.all([loadTeachers(), loadList()]);
        })();
    </script>
</body>
</html>
