    ...
    <div class="main-content flex-grow-1">
        <header class="d-flex justify-content-between align-items-center mb-4">
            <div class="d-flex align-items-center">
                ...
                <span class="badge bg-danger-subtle text-danger border border-danger-subtle rounded px-2 py-1" style="font-size: 0.70rem;">Registry</span>
            </div>
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
            <div>
                ...
                <p class="text-muted small mb-0">CRUD for <code>student_registry</code> (code, name, gender, DOB, contact, school / stage / section).</p>
            </div>
        ...
        <div class="card border-0 shadow-sm rounded-4 p-3 mb-3 bg-white">
            <div class="row g-2 align-items-end">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control rounded-3" id="searchInput" placeholder="Name, code, or email…">
                </div>
                <div class="col-md-3">
                ...
                <form id="registryForm">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded-3" name="student_code" id="field_student_code" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label small">Full name *</label>
                            <input type="text" class="form-control rounded-3" name="student_full_name" id="field_student_full_name" required>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" class="form-control rounded-3" name="school_id" id="field_school_id" min="0">
                        </div>
                        <div class="col-md-2">
                            <label class="form-label small">Stage ID</label>
                            <input type="number" class="form-control rounded-3" name="stage_id" id="field_stage_id" min="0">
                        </div>
                        <div class="col-md-2">
                            <label class="form-label small">Section ID</label>
                            <input type="number" class="form-control rounded-3" name="section_id" id="field_section_id" min="0">
                        </div>
                    </div>
                </form>
            </div>
...
(function () {
    ...
    async function loadList() {
        hideErr();
        bodyEl.innerHTML = '<tr><td colspan="' + colCount + '" class="text-center py-4 text-muted">Loading…</td></tr>';
        ...
        if (!res.success) {
            ...
            bodyEl.innerHTML = '<tr><td colspan="' + colCount + '" class="text-center py-4 text-danger">Error</td></tr>';
            return;
        }
        const rows = res.data || [];
        if (!rows.length) {
            bodyEl.innerHTML = '<tr><td colspan="' + colCount + '" class="text-center py-4 text-muted">No records yet. Add students from the database or use “Add student” (admin).</td></tr>';
            return;
        }
    ...
    async function delRow(id) {
        ...
        hideErr();
        const res = await apiFetch('/student-registry/' + id, { method: 'DELETE' });
        if (!res) return;
        if (!res.success) {
